...
st.set_page_config(
    page_title="Galaxy Zoo @ AI4DeSci ",
...
st.title("Galaxy Zoo Mini-App Deployed @ AI4DeSci")
...
st.write('Original App by Mike Walmsley ([@mike_walmsley_](https://twitter.com/mike_walmsley_))')
st.write('Original Unabridged repo [here](https://github.com/mwalmsley/galaxy-poster/tree/master)')